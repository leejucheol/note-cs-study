...
# 배열안에 task가 a,b일 경우 a가 나오고 간격이 최소 n이므로 a가 나온후 n만큼의 간격이 필요
# 그럼 a가 나온후 n만큼의 간격이 필요하므로 b가 나와야함
# 만약 n이 2일경우 a가 나오고 b가 나오고 n만큼의 간격이 필요하므로 idle이 나와야함
# 그럼 a가 나오고 b가 나오고 idle이 나오고 a가 나와야함
